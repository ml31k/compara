...
use lib "/hpf/largeprojects/mdwilson/scripts/Compara/scripts/lib/compara102/ensembl/modules/";;
use lib "/hpf/largeprojects/mdwilson/scripts/Compara/scripts/lib/compara102/ensembl-compara/modules/";;
